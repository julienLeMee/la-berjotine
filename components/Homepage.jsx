  ...
  return (
    <div className='flex items-center justify-center h-screen bg-fixed bg-center bg-cover custom-img'>
      ...
      <div className='max-w-[80%] text-white z-[2]'>
        <div>
        {/* <h1 style={{backdropFilter: 'blur(4px)'}} className='text-6xl bg-[#01647C]/20 rounded-lg p-2'>LA BERJOTINE</h1> */}
        {/* <h1 style={{backdropFilter: 'blur(3px)'}} className='text-6xl'>LA BERJOTINE</h1> */}
        <h1 style={{textShadow: '0 0 10px #01647C'}} className='text-6xl'>LA BERJOTINE</h1>
        {/* <h1 className='text-6xl'>LA BERJOTINE</h1> */}
