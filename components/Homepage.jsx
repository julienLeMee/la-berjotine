...
const Homepage = () => {
  return (
    <div className='flex items-center justify-center h-screen bg-fixed bg-center bg-cover'>
      <img src='/assets/berjotine-homepage-3.jpg' alt='homepage' className='absolute top-0 left-0 right-0 bottom-0 z-[1] w-full h-screen object-cover' />
      <div className='absolute z-[2]' />
        <div className='max-w-[80%] text-white z-[2] mb-24'>
          ...
          <p style={{textShadow: '0 0 10px #01647C'}} className='my-4 text-xl'>Un coin de paradis au coeur du charolais</p>
          </div>
          <div className="w-24">
            <Link href='/contact'>
