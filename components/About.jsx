...
const About = () => {
  return (
    <div id='about' className='w-full md:h-screen p-16 lg:p-32 flex items-center mb-2 md:mb-10'>
      <div className='max-w-[1100px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>La Berjotine vous propose 3 chambres aux charmes très différents, au coeur d'une maison du 18 ème siècle.
 ...
 Entièrement renovée, elle allie ancien et modernité. Une décoration toute en nuances de couleurs, qui crée une ambiance pour chaque espace. Bientôt un jardin et sa terrasse couverte agrémenteront l'espace extérieur.</p>
          <p className='py-2 text-gray-600 underline cursor-pointer'>Voir les chambres</p>
        </div>
